...
function Modal() {
  ...
  // only show modal if open is true/available
  return (
    <Transition.Root show={open} as={Fragment}>
      {/* will get rendered out as a div => as="div" */}
      <Dialog
        as="div"
      ...
      >
        ...
        >
          ...
          >
            <div
              className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-5 text-left
            ...
            >
              <div>
                {selectedFile ? (
                  ...
                  <div
                    onClick={() => filePickerRef.current.click()} // simulate a fake click
